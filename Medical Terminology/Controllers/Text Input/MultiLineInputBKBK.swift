...
protocol MultiLineInputDelegateBKBBKK: AnyObject {
	func shouldUpdateMultiLineInfo(inputVC: MultiLineInputVC, itemReference: String, cleanString: String)
}

class MultiLineInputVCBKBKBK: UIViewController, UITextViewDelegate {
